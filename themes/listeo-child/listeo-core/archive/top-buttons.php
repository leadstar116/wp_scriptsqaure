	...
	<div class="sort-by">
		<div class="sort-by-select">
			...
			<select form="listeo_core-search-form" name="listeo_core_order" data-placeholder="<?php esc_attr_e('Sort by Distance', 'listeo_core'); ?>" class="chosen-select-no-single orderby" >
                <option <?php selected($default,'distance-asc'); ?> value="distance-asc"><?php esc_html_e( 'Sort by Distance (asc)' , 'listeo_core' ); ?></option>
				<option <?php selected($default,'distance-desc'); ?> value="distance-desc"><?php esc_html_e( 'Sort by Distance (desc)' , 'listeo_core' ); ?></option>
                <option <?php selected($default,'price-asc'); ?> value="price-asc"><?php esc_html_e( 'Sort by Price (asc)' , 'listeo_core' ); ?></option>
				<option <?php selected($default,'price-desc'); ?> value="price-desc"><?php esc_html_e( 'Sort by Price (desc)' , 'listeo_core' ); ?></option>
			</select>
		</div>
	</div>
	<!-- Sort by / End -->
